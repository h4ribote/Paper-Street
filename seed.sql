...
INSERT INTO api_keys (api_key, user_id, role, created_at) VALUES
    (SUBSTRING(SHA1('role:market_maker'), 1, 20), 1000, 'market_maker', 0),
    (SUBSTRING(SHA1('role:liquidity_provider'), 1, 20), 1001, 'liquidity_provider', 0),
    (SUBSTRING(SHA1('role:whale_northern'), 1, 20), 1002, 'whale_northern', 0),
    (SUBSTRING(SHA1('role:whale_oceanic'), 1, 20), 1003, 'whale_oceanic', 0),
    (SUBSTRING(SHA1('role:whale_energy'), 1, 20), 1004, 'whale_energy', 0),
    (SUBSTRING(SHA1('role:national_ai_arcadia'), 1, 20), 1005, 'national_ai_arcadia', 0),
    (SUBSTRING(SHA1('role:national_ai_boros'), 1, 20), 1006, 'national_ai_boros', 0),
    (SUBSTRING(SHA1('role:national_ai_el_dorado'), 1, 20), 1007, 'national_ai_el_dorado', 0),
    (SUBSTRING(SHA1('role:national_ai_neo_venice'), 1, 20), 1008, 'national_ai_neo_venice', 0),
    (SUBSTRING(SHA1('role:national_ai_san_verde'), 1, 20), 1009, 'national_ai_san_verde', 0),
    (SUBSTRING(SHA1('role:national_ai_novaya_zemlya'), 1, 20), 1010, 'national_ai_novaya_zemlya', 0),
    (SUBSTRING(SHA1('role:national_ai_pearl_river'), 1, 20), 1011, 'national_ai_pearl_river', 0),
    (SUBSTRING(SHA1('role:momentum_chaser_a'), 1, 20), 1012, 'momentum_chaser_a', 0),
    (SUBSTRING(SHA1('role:momentum_chaser_b'), 1, 20), 1013, 'momentum_chaser_b', 0),
    (SUBSTRING(SHA1('role:momentum_chaser_c'), 1, 20), 1014, 'momentum_chaser_c', 0),
    (SUBSTRING(SHA1('role:dip_buyer_a'), 1, 20), 1015, 'dip_buyer_a', 0),
    (SUBSTRING(SHA1('role:dip_buyer_b'), 1, 20), 1016, 'dip_buyer_b', 0),
    (SUBSTRING(SHA1('role:dip_buyer_c'), 1, 20), 1017, 'dip_buyer_c', 0),
    (SUBSTRING(SHA1('role:reversal_sniper_a'), 1, 20), 1018, 'reversal_sniper_a', 0),
    (SUBSTRING(SHA1('role:reversal_sniper_b'), 1, 20), 1019, 'reversal_sniper_b', 0),
    (SUBSTRING(SHA1('role:reversal_sniper_c'), 1, 20), 1020, 'reversal_sniper_c', 0),
    (SUBSTRING(SHA1('role:grid_trader_a'), 1, 20), 1021, 'grid_trader_a', 0),
    (SUBSTRING(SHA1('role:grid_trader_b'), 1, 20), 1022, 'grid_trader_b', 0),
    (SUBSTRING(SHA1('role:grid_trader_c'), 1, 20), 1023, 'grid_trader_c', 0),
    (SUBSTRING(SHA1('role:news_reactor'), 1, 20), 1024, 'news_reactor', 0),
    (SUBSTRING(SHA1('role:arbitrageur'), 1, 20), 1025, 'arbitrageur', 0),
    (SUBSTRING(SHA1('role:yield_hunter'), 1, 20), 1026, 'yield_hunter', 0),
    (SUBSTRING(SHA1('role:public_consumer'), 1, 20), 1027, 'public_consumer', 0),
    (SUBSTRING(SHA1('role:corporate_ai_omni'), 1, 20), 101, 'corporate_ai_omni', 0),
    (SUBSTRING(SHA1('role:corporate_ai_nyx'), 1, 20), 102, 'corporate_ai_nyx', 0),
    (SUBSTRING(SHA1('role:corporate_ai_qdy'), 1, 20), 104, 'corporate_ai_qdy', 0),
    (SUBSTRING(SHA1('role:corporate_ai_cyb'), 1, 20), 105, 'corporate_ai_cyb', 0),
    (SUBSTRING(SHA1('role:corporate_ai_sld'), 1, 20), 106, 'corporate_ai_sld', 0),
    (SUBSTRING(SHA1('role:corporate_ai_ttn'), 1, 20), 107, 'corporate_ai_ttn', 0),
    (SUBSTRING(SHA1('role:corporate_ai_neb'), 1, 20), 108, 'corporate_ai_neb', 0),
    (SUBSTRING(SHA1('role:corporate_ai_sol'), 1, 20), 109, 'corporate_ai_sol', 0),
    (SUBSTRING(SHA1('role:corporate_ai_atm'), 1, 20), 110, 'corporate_ai_atm', 0),
    (SUBSTRING(SHA1('role:corporate_ai_glt'), 1, 20), 111, 'corporate_ai_glt', 0),
    (SUBSTRING(SHA1('role:corporate_ai_shd'), 1, 20), 112, 'corporate_ai_shd', 0),
    (SUBSTRING(SHA1('role:corporate_ai_chm'), 1, 20), 113, 'corporate_ai_chm', 0),
    (SUBSTRING(SHA1('role:corporate_ai_vph'), 1, 20), 114, 'corporate_ai_vph', 0),
    (SUBSTRING(SHA1('role:corporate_ai_pan'), 1, 20), 115, 'corporate_ai_pan', 0),
    (SUBSTRING(SHA1('role:corporate_ai_sdl'), 1, 20), 116, 'corporate_ai_sdl', 0),
    (SUBSTRING(SHA1('role:corporate_ai_rox'), 1, 20), 117, 'corporate_ai_rox', 0),
    (SUBSTRING(SHA1('role:corporate_ai_gnn'), 1, 20), 118, 'corporate_ai_gnn', 0),
    (SUBSTRING(SHA1('role:corporate_ai_ifa'), 1, 20), 119, 'corporate_ai_ifa', 0),
    (SUBSTRING(SHA1('role:corporate_ai_aeg'), 1, 20), 120, 'corporate_ai_aeg', 0),
    (SUBSTRING(SHA1('role:corporate_ai_trn'), 1, 20), 121, 'corporate_ai_trn', 0),
    (SUBSTRING(SHA1('role:corporate_ai_vdc'), 1, 20), 122, 'corporate_ai_vdc', 0),
    (SUBSTRING(SHA1('role:corporate_ai_hrz'), 1, 20), 123, 'corporate_ai_hrz', 0)
ON DUPLICATE KEY UPDATE
