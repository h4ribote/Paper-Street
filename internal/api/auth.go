...
func isPublicPath(path string) bool {
	...
	switch cleanPath {
	case "/", "/index.html", "/login.html", "/dashboard.html", "/trade.html", "/news.html", "/portfolio.html", "/health", "/auth/login", "/auth/bot", "/auth/discord/login", "/auth/callback", "/ws", "/api/market/ticker":
		return true
	}
