...
| **2** | **Fish** | 500 | 0.020% | 0.075% | -5% | 一般大衆投資家。デイリーを1週間こなす。 |
| **3** | **Shark** | 2,500 | 0.010% | 0.050% | -10% | 獰猛なトレーダー。小規模な納品を行う。 |
| **4** | **Whale** | 15,000 | 0.000% | 0.025% | -20% | 市場を動かす大口。**現物納品が必須級**。 |
| **5** | **Leviathan** | 50,000 | 0.000% | 0.000% | -50% | 伝説級の支配者。国家・企業の調達係。 |

**重要**: Whale 以上になるためには、デイリーミッションだけでは到達困難です。**[Corporate Contracts](./CONTRACTS.md)** を通じた大規模な現物納品を行い、大量のXPを獲得する必要があります。
...
* **FX手数料優遇 (FX Fee Discount)**:
    * FX取引（AMM Swap）における手数料に対して、Leviathanのみ特別な優遇レートが適用されます。
    * **Low Fee Tier**: 0.04% -> **0.02%**
    * **Standard Fee Tier**: 0.20% -> **0.10%**
    * ※ 割引分はLPへの補填はなく、単純に徴収額が減少します。
...
| **Safety First** | 「国債（Consol Bond）」を購入する。 | 利息収入の存在を教える。 |
...
| **Liquidity King** | FXの流動性プールに、10,000 ARC 以上の流動性を供給する。 | 為替市場の安定化への貢献。 |
...
2. **マスタ参照**: `rank_definitions` から該当ランクの手数料・割引パラメータを取得。
3. **コスト計算**:
    * **手数料**: `約定額 × fee_rate`
