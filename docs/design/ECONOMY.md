...
### 1.4. マクロ資金循環と大衆消費 (Macro Fund Circulation & Consumer Sink)
Paper Street の経済システムは、無からお金が生まれ続けるインフレモデルではなく、以下のような「資金の循環と消滅」のサイクルを持っています。

#### A. 資金フローの定義 (Fund Cycle)
1.  **企業からの給与支払い (Corporate Payroll)**
    *   各企業は、収益の一部を「人件費（固定費）」として支払います。
    *   この資金は、その国に所属する「大衆消費者Bot (The Public)」のウォレットに振り込まれます。
2.  **国家AIによる徴税と給付 (Taxation & UBI)**
    *   **徴税**: 国家は企業の利益から法人税を徴収します。
    *   **給付 (UBI)**: 国家は徴収した税金を原資として、大衆消費者Botに「ベーシックインカム」を支給します。
3.  **財政赤字と国債発行 (National Debt)**
    *   不況で税収が減り、UBIの原資が不足した場合、国家は市場で**国債（Consols）を新規発行（売り出し）**します。
    *   プレイヤーや投資機関がこれを購入することで、民間の資金が国家に吸い上げられ、それが給付金として消費者に渡ります。

#### B. 消費とBurnメカニズム (Consumption Logic)
「大衆消費者Bot」は、給与と給付金で得た予算を使って、市場からモノを買って消費します。

*   **行動**: 予算の範囲内で「B2Cコモディティ（穀物、合成肉、高級品など）」を市場から**成行買い（Market Buy）**します。
*   **Burn**: 購入されたコモディティは即座にデータベースから削除（Burn）され、市場から消滅します。
*   **連動**: 失業率が上がると（企業の業績悪化で給与が減ると）、消費者の購買力が落ち、高級品などの需要が減少して価格が下落するというデフレ圧力が働きます。
...
### 2.2. 企業金融 (Corporate Finance)
企業は、製品の売買だけでなく、資本市場を通じた資金調達や株主還元も行います。
詳細なメカニズムについては [Equity Financing & Share Buybacks](./EQUITY_FINANCING.md) を参照してください。

*   **資金調達 (Equity Financing)**:
    *   **公募増資 (Public Offering)**: 現金不足時や積極的な設備投資が必要な場合、新株を発行して市場で売却します。
    *   **影響**: 発行済株式数が増加し、1株あたりの価値が希薄化（Dilution）します。
*   **株主還元 (Share Buyback)**:
    *   **自社株買い**: 余剰資金がある場合や株価が割安な場合、市場から自社株を買い戻して消却します。
    *   **影響**: 発行済株式数が減少し、EPS（1株益）が上昇します。
