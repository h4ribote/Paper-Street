...
*   **Bonds**: イールドカーブの概念を導入。短期・中期・長期国債の利回り変動。プレイヤー自身も債券を発行し資金調達が可能（Post-MVP）。
*   **Forex**: 為替変動を利用した取引。**流動性プール (AMM: Automated Market Maker)** を使用し、基軸通貨である**ARC**と各通貨のペア（例: VDP/ARC, BRB/ARC）で取引されます。
    ...
    *   **流動性提供**: プレイヤーはプールに流動性を提供することで、手数料収入を得ることができます (Post-MVP)。
*   **Derivatives**: オプションや先物など（Post-MVP）。
...
FX市場における流動性プールへの手数料支払いも、この `fee_tier` に基づいて計算されます。
