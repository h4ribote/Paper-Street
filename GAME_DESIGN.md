...
### 競技モード (PvP Battles)
*   **「The Pit」 (短期決戦)**: 制限時間（例: 10分）内で、特定のボラティリティの高い銘柄を取引し、ROI（投資利益率）を競う。
*   **ショートスクイズ合戦**: 空売りを行っているプレイヤーを特定（建玉情報のリーク等）し、買い支えてロスカットさせる戦略的PvP。
...
*   **ランキング**: 「総資産額」「最大瞬間ROI」「The Pit勝利数」などでランキングを決定。
*   **報酬**:
    ...
    *   **Skill Tree (Rogue-lite要素)**: 獲得したポイントで、次シーズンの初期ステータス（手数料割引、情報取得速度など）を微強化。
